...
cad_image_markup_main: /usr/local/lib/libpcl_common.so
cad_image_markup_main: /usr/local/lib/libpcl_octree.so
cad_image_markup_main: /usr/lib/libOpenNI.so
cad_image_markup_main: /usr/local/lib/libpcl_io.so
cad_image_markup_main: /usr/lib/x86_64-linux-gnu/libflann_cpp_s.a
cad_image_markup_main: /usr/local/lib/libpcl_kdtree.so
cad_image_markup_main: /usr/local/lib/libpcl_search.so
cad_image_markup_main: /usr/local/lib/libpcl_sample_consensus.so
cad_image_markup_main: /usr/local/lib/libpcl_filters.so
cad_image_markup_main: /usr/local/lib/libpcl_features.so
cad_image_markup_main: /usr/local/lib/libpcl_ml.so
cad_image_markup_main: /usr/local/lib/libpcl_segmentation.so
cad_image_markup_main: /usr/local/lib/libpcl_visualization.so
cad_image_markup_main: /usr/lib/x86_64-linux-gnu/libqhull.so
cad_image_markup_main: /usr/local/lib/libpcl_surface.so
cad_image_markup_main: /usr/local/lib/libpcl_registration.so
cad_image_markup_main: /usr/local/lib/libpcl_keypoints.so
cad_image_markup_main: /usr/local/lib/libpcl_tracking.so
cad_image_markup_main: /usr/local/lib/libpcl_recognition.so
cad_image_markup_main: /usr/local/lib/libpcl_stereo.so
cad_image_markup_main: /usr/local/lib/libpcl_outofcore.so
cad_image_markup_main: /usr/local/lib/libpcl_people.so
cad_image_markup_main: /usr/lib/x86_64-linux-gnu/libboost_system.so
cad_image_markup_main: /usr/lib/x86_64-linux-gnu/libboost_filesystem.so
cad_image_markup_main: /usr/lib/x86_64-linux-gnu/libboost_thread.so
cad_image_markup_main: /usr/lib/x86_64-linux-gnu/libboost_date_time.so
