...
public:
   ...
   */
  void DisplayClouds(PointCloud::Ptr cloud1, PointCloud::Ptr cloud2,
   ...
   */
  void DisplayClouds(PointCloud::Ptr cloud1, PointCloud::Ptr cloud2,
                     PointCloud::Ptr cloud3, std::string id1, std::string id2,
                     std::string id3);
  ...
  void DisplayClouds(PointCloud::Ptr cloud1, PointCloud::Ptr cloud2,
                     ...
                     std::string id1, std::string id2, std::string id3,
                     std::string id4);
  ...
  void DisplayClouds(PointCloud::ConstPtr image_cloud,
                     PointCloud::Ptr cad_cloud, PointCloud::Ptr projected_cloud,
                     pcl::CorrespondencesConstPtr corrs, std::string id_image,
