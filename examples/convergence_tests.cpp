...
TEST_CASE("Convergence Testing - Manual Labels") {
  ...
  for (int view = 1; view <= 4; view++) {
    ...
    cad_image_markup::CadImageMarkup::Inputs inputs{
      ...
      .image_path = data_root + "labelled_images/real_view_" + std::to_string(view) + "_feature_label.json",
      .canny_edge_image_path = data_root + "canny_edge/canny_edges.png",
      .defect_path = data_root + "marked_up_images/real_view_" + std::to_string(view) + "_image.png",
      ...
      .output_image_path =
          data_root + "marked_up_cad/real_cad_view_" + std::to_string(view) + "_markup.png"};
